	...
	\begin{minipage}[t][10cm][t]{\textwidth}
		...
		\begin{figure}[h]
			\begin{center}
				...
				\path (p15.south)+(0.0,-2.0) \ioitem{16}{15. Likelihood \\of an allele given another allele};
				\visible<4->{\path (p10.east)+(+4.1,0.0) node (ur1)[ur] {\color{black}\lstinline|get_allele_likelihood_read()|};}
				\visible<5->{\path (ur1.east)+(-2.57,2.1) node (ur2)[ur] {\color{black}\lstinline|get_alignment_likelihood()|};}
				\visible<6->{\path (p12.east)+(8.0-4,0) node (ur3)[ur] {\color{black}\lstinline|calc_vafs_likelihood_read()|};}
				\visible<7->{\path (p14.east)+(9.5-6,0) node (ur4)[ur] {\color{black}\lstinline|calc_vafs_likelihood()|};}
				...
				\visible<4->{\draw [funtool] (p10.east) -- (ur1);}
				\visible<5->{\draw [dashedline] (ur2.south) -- (ur1.north);}
				\visible<6->{\draw [funtool] (p12.east) -- (ur3);}
				\visible<7->{\draw [funtool] (p14.east) -- (ur4);}
				\end{tikzpicture}
			\end{center}
		\end{figure}
		}
	...
	\begin{minipage}[t][10cm][t]{\textwidth}	
		...
		\begin{figure}[h]
			\begin{center}
				...
				\visible<5->{\path (p11.north)+(-0.0, 3.5) node (ur2)[ur] {\color{black}\lstinline|calc_loci_likelihoods()|};}
				\visible<6->{\path (p16.east)+(4.0, 0.0) node (ur3)[ur] {\color{black}\lstinline|get_heterozygosity()|};}
				\visible<7->{\path (ur3.north)+(0.0, 1.5) node (ur4)[ur] {\color{black}\lstinline|get_cigar_tuples()|};}
				\visible<8->{\path (p17.east)+(5.1, 0.0) node (ur5)[ur] {\color{black}\lstinline|get_allele_likelihood_alleles()|};}
				
				\visible<5->{\path [dashedline] (ur2.south) -- node [left] {} (ur1.north);}
				\visible<7->{\path [dashedline] (ur4.south) -- node [left] {} (ur3.north);}
				
				% Pfeile%
				\visible<4->{\draw [funtool] (p11.north) -- (ur1.south);}		
				\visible<6->{\draw [funtool] (p16.east) -- (ur3.west);}	
				\visible<8->{\draw [funtool] (p17.east) -- (ur5.west);}
				\end{tikzpicture}
			\end{center}
		\end{figure}
		}
